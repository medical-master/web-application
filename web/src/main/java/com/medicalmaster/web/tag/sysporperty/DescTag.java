 ...
 * </P>
 */
public class DescTag implements Tag {
	static Logger log = LoggerFactory.getLogger(DescTag.class);
	...
	public int doEndTag() throws JspException {
		try {
			String desc = SysPropertyHelper.getDesc(categoryId, propertyId);
			...
			log.error("categoryId {}  propertyId {}  DescTag failed!", categoryId, propertyId, e);
		}
		return 0;
	}
