...
import com.medicalmaster.common.user.RemoveUserRequest;
import com.medicalmaster.web.control.WebContext;
import com.medicalmaster.web.helper.ResourceProxy;
import com.xross.tools.xunit.Context;
import com.xross.tools.xunit.Processor;

public class RemoveUserAction implements Processor{
	private String userResource = "users";
	
	@Override
	public void process(Context ctx) {
		WebContext context = (WebContext)ctx;
		Status guir = ResourceProxy.delete(context, context.getBaseServiceUrl() + userResource, RemoveUserRequest.class, Status.class);
