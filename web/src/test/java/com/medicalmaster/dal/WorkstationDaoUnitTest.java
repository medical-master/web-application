...
/**
 * JUnit test of WorkstationDao class.
 * Before run the unit test, you should initiate the test data and change all the asserts correspond to you case.
**/
public class WorkstationDaoUnitTest {

	private static final String DATA_BASE = "medical_master";

	private static DalClient client = null;
	private static WorkstationDao dao = null;
	...
	public void testDelete2() throws Exception {
		DalHints hints = new DalHints();
		List<Workstation> daoPojos = null;
	...
	public void testGetAll() throws Exception {
		List<Workstation> list = dao.getAll(new DalHints());
	}
	...
	public void testQueryByPage() throws Exception {
		...
		int pageSize = 100;
		int pageNo = 1;
		List<Workstation> list = dao.queryByPage(pageSize, pageNo, hints);
	}
	...
	public void testQueryByPk1() throws Exception {
		Number id = null;
		DalHints hints = new DalHints();
		Workstation ret = dao.queryByPk(id, hints);
	}
	...
	public void testQueryByPk2() throws Exception {
		Workstation pk = null;
		DalHints hints = new DalHints();
		Workstation ret = dao.queryByPk(pk, hints);
	}
