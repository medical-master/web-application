...
/**
 * JUnit test of SystemPropertyCategoryDao class.
 * Before run the unit test, you should initiate the test data and change all the asserts correspond to you case.
**/
public class SystemPropertyCategoryDaoUnitTest {

	private static final String DATA_BASE = "medical_master";

	private static DalClient client = null;
	private static SystemPropertyCategoryDao dao = null;
	...
	public static void setUpBeforeClass() throws Exception {
		...
		**/
		...
		dao = new SystemPropertyCategoryDao();
	}
	...
	public void testDelete1() throws Exception {
		...
		SystemPropertyCategory daoPojo = null;
	...
	public void testDelete2() throws Exception {
		DalHints hints = new DalHints();
		List<SystemPropertyCategory> daoPojos = null;
	...
	public void testGetAll() throws Exception {
		List<SystemPropertyCategory> list = dao.getAll(new DalHints());
	}
	...
	public void testQueryByPage() throws Exception {
		...
		int pageSize = 100;
		int pageNo = 1;
		List<SystemPropertyCategory> list = dao.queryByPage(pageSize, pageNo, hints);
	}
	...
	public void testQueryByPk1() throws Exception {
		Number id = null;
		DalHints hints = new DalHints();
		SystemPropertyCategory ret = dao.queryByPk(id, hints);
	}
	
	@Test
	public void testQueryByPk2() throws Exception {
		SystemPropertyCategory pk = null;
		DalHints hints = new DalHints();
		SystemPropertyCategory ret = dao.queryByPk(pk, hints);
	}
