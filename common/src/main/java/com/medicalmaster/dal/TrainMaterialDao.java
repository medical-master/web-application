...
public class TrainMaterialDao {
	...
	/**
	 * Query TrainMaterial by the specified ID
	 * The ID must be a number
	**/
	public TrainMaterial queryByPk(Number id, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
		return client.queryByPk(id, hints);
	}
    /**
	 * Query TrainMaterial by TrainMaterial instance which the primary key is set
	**/
	public TrainMaterial queryByPk(TrainMaterial pk, DalHints hints)
			throws SQLException {
		hints = DalHints.createIfAbsent(hints);
	...
	**/
	...
	/**
	 * Query TrainMaterial with paging function
